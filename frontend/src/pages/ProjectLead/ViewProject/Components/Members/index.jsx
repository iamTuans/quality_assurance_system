    ...
    return (
        <div className="group-add-user">
            ...
            <div className="add-user">
                <Input placeholder="Username" size="large" onChange={(e) => setNewUser({
                    ...newUser,
                    username: e.target.value
                })}/>
                <Select options={roleOptions} placeholder="Role" size="large" onChange={(e) => setNewUser({
                    ...newUser,
                    role: e
                })} />
                <DatePicker
                    ...
                    style={{ width: '100%' }}
                    format="DD/MM/YYYY"
                    onChange={(date, dateString) => setNewUser({
                        ...newUser,
                ...
                />
                <Button type="primary" size="large" onClick={() => handleAddUser()}>Add</Button>
            </div>
            <div>
                <UnorderedListOutlined />
